...
Plugin URI: https://xpertsol.org/demo/ramadhan-countdown-demo/
...
$('.popup_ram').hide();
			...
			$.ajax({
			    url : '//xpertsol.org/WP_api_ramadhan_countdown/<?php echo 'inc_data_pray_ramadan.php?city='.$a['city'].'&country='.$a['country'].'&method='.$a['method'].'&timezone='.$a['timezone'].'&before='.$a['before']; ?>',
			     headers: {
